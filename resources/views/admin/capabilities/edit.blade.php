...
<body>
    <div class="container py-4">
        ...
        <form method="POST" action="{{ route('admin.capabilities.update', $capability) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3"><label class="form-label">Image</label><input type="text" name="image" class="form-control" value="{{ $capability->image }}"></div>
