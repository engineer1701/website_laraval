...
<body>
    <div class="container py-4">
        ...
        <form method="POST" action="{{ route('admin.articles.update', $article) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3"><label class="form-label">Image</label>@if($article->image)<img src="{{ $article->publicImageUrl($article->image) }}" class="d-block mb-2" style="max-width:180px;max-height:120px;object-fit:cover" alt="Current image">@endif<input type="file" name="image" accept="image/*" class="form-control"><small class="text-muted">Choose a new image to replace the current one.</small></div>
